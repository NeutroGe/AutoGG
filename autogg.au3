...
$disable_auto_page_opening = 1 ; if set to 1 then doesn't open op.gg stat page automatically (useful for getting premade infos only)
...
$gui = GUICreate("sstats", 319, 496, $posx, $posy, $WS_POPUP)
;GUISetState(@SW_HIDE)
...
;~ 				$summoners_names_list[5] = "ChaselEmily"
				...
				settext($summoner1_gui, "Update done!" & @CRLF & @CRLF & "Check OP.GG summary page below for results (automatically opened in your browser)")
						...
						if $enemy_stats_done = 0 then
							...
							WEnd
							 ...
							 Else   ; our team is the blue team => the enemy team is the red team
								...
								settext($summoner6_gui, "Update done!" & @CRLF & @CRLF & "Check OP.GG summary page below for results (automatically opened in your browser)")
